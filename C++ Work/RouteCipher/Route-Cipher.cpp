...
string sentence_validation(string sentenceI)
{
    ...
    {
        string sentenceII;
        cout << "Enter a message containing at least 4 alphabetical characters: ";
        getline(cin, sentenceI);
...
{
    int key;
    printf("Enter the key (2 -> %d): ", (EN_Size / 2));
    while (!(cin >> key))
    {
...
int main()
{
    ...
    while (true)
    {
        ...
        if (answer == "1")
        {
            ...
            cout << "----------------------------------" << endl;
            cout << "The encrypted text is: " << zSentence << endl;
            cout << "----------------------------------" << endl;
            system("pause");
        }
        else if (answer == "2")
        {
            ...
            cout << "----------------------------------" << endl;
            cout << "The decrypted text is: " << zSentence << endl;
            cout << "----------------------------------" << endl;
            system("pause");
        }
        else if (answer == "0")
        {
            system("cls");
            cout << "Thanks for using Route Cipher :)" << endl;
            break;
        }
    }
    return 0;
